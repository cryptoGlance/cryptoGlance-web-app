...
<?php require_once("includes/modal-delete_prompt.php"); ?>
      ...
      <div class="container sub-nav">
         ...
         <h1>Your Mining Rigs:</h1>
         
         [[ TABLE? ]]

         <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addRig" data-backdrop="static"><i class="icon icon-circleadd"></i> Add Rig</button>
