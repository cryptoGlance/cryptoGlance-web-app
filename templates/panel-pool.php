<div id="pool-<?php echo $poolId?>" class="panel panel-primary panel-pool" data-type="pool" data-id="<?php echo $poolId?>">
   ...
   <div class="panel-heading">
      ...
      <button type="button" class="panel-header-button" data-toggle="modal" data-target="#editPool" data-backdrop="static"><i class="icon icon-managedhosting"></i> Manage</button>
