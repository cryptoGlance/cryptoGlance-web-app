<div id="pool-<?php echo $poolId?>" class="panel panel-primary panel-pool" data-type="pool" data-id="<?php echo $poolId?>">
   ...
   <div class="panel-heading">
        ...
        <button type="button" class="panel-header-button btn-edit-pool" data-type="pool" data-toggle="modal" data-target="#editPool" data-attr="<?php echo $poolId?>"><i class="icon icon-edit"></i> Edit</button>
